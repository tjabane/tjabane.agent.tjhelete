...
| --- | ----------- | ---------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| H1  | In progress | The current `BankApiClient` requires an `accountId`, while financial tools must cover the complete account set.                    | `BankApiClient.getAccounts()` and the Investec account decoder/mapper are implemented. Remaining: application capabilities must query all returned accounts and reject incomplete balance, transaction-list, and spending-summary aggregates. Do not expose account selectors or accept provider account identifiers from model arguments. |
